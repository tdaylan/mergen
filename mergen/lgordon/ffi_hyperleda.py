...
class hyperleda_ffi(object):
    ...
    def load_lc_metafiles_all(self):
            ...
            for n in range(len(files)):
                if files[n].endswith('_lightcurves.fits'):
                    ...
                    if self.timeaxis is None:
                        ...
                        self.intensities = np.vstack((self.intensities, f[1].data))
                    f.close()
    ...
    def load_lc_metafile(self):
        """ Loads metafiles in the datapath folder if they exist"""
